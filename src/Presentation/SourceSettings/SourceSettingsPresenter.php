...
final class SourceSettingsPresenter extends SecuredPresenter
{
    ...
    public function actionDefault(int $id): void
    {
        ...
        if ($form instanceof Form && !$form->isSubmitted()) {
            $defaults = ['version' => $source['lock_version'], 'priority' => $source['priority'], 'active' => true];
    ...
    protected function createComponentSettingsForm(): Form
    {
        ...
        $form->onSuccess[] = function (Form $form): void {
            ...
            try { $this->settings->save((int) $this->getUser()->getId(), $this->sourceId, (int) $v['version'], (string) $v['priority'], $v['name'] ?? null, $v['query'] ?? null, (bool) ($v['active'] ?? true)); }
